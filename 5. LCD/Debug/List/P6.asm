...
_0x0:
	.DB  0x68,0x65,0x6C,0x6C,0x6F,0x0,0x74,0x6F
	.DB  0x20,0x61,0x6C,0x6C,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0013       lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 0014       lcd_putsf("hello");
	__POINTW2FN _0x0,0
	RCALL SUBOPT_0x0
; 0000 0015       delay_ms(500);
; 0000 0016       lcd_clear();
; 0000 0017 
; 0000 0018       lcd_gotoxy(6,1);
	LDI  R30,LOW(6)
	ST   -Y,R30
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
; 0000 0019       lcd_putsf("to all");
	__POINTW2FN _0x0,6
	RCALL SUBOPT_0x0
...
; 0000 0029 DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (0<<DDA0);
	LDI  R30,LOW(0)
	OUT  0x1A,R30
; 0000 002A // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=P
; 0000 002B PORTA=(0<<PORTA7) | (0<<PORTA6) | (0<<PORTA5) | (0<<PORTA4) | (0<<PORTA3) | (0<<PORTA2) | (0<<PORTA1) | (1<<PORTA0);
	LDI  R30,LOW(1)
	OUT  0x1B,R30
; 0000 002C 
...
; 0000 008F // RS - PORTB Bit 1
; 0000 0090 // RD - PORTB Bit 2
; 0000 0091 // EN - PORTB Bit 3
