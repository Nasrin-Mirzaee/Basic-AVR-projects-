...
;#include <delay.h>
;
;#define button PORTD.0      //PORTD.0 AS INPUT CONNECT TO THE KEY
;
;// Declare your global variables here
;const unsigned char digit[10]={0x3F, 0x06, 0x5B, 0x4F, 0x66, 0x6D, 0x7D, 0x07, 0x7F, 0x6F};
;unsigned char i;            // Counter variable (0-9)
;
;void init(void);
;
;void main(void)
...
_0x3:
; 0000 0014       {
; 0000 0015       PORTB = digit[i];     // Send the pattern for digit[i] to PORTB ? display number on 7-segment
	MOV  R30,R5
	LDI  R31,0
...
; 0000 0017       delay_ms(200);
	...
	LDI  R27,0
	CALL _delay_ms
; 0000 0018       i++;                  // Go to next digit
	INC  R5
; 0000 0019       i= i==10 ? 0:i;       // If i reaches 10, reset it back to 0
	LDI  R30,LOW(10)
	CP   R30,R5
	BRNE _0x7
	LDI  R30,LOW(0)
...
; 0000 0039 DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	OUT  0x11,R30
; 0000 003A // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=P
; 0000 003B PORTD=(0<<PORTD7) | (0<<PORTD6) | (0<<PORTD5) | (0<<PORTD4) | (0<<PORTD3) | (0<<PORTD2) | (0<<PORTD1) | (1<<PORTD0);
	LDI  R30,LOW(1)
	OUT  0x12,R30
; 0000 003C 
