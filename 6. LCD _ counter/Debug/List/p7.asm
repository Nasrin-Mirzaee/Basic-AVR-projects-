...
;DATA STACK POINTER INITIALIZATION
	...
	.CSEG
;#include <mega32.h>       // Include header for ATmega32 microcontroller
...
;#include <stdio.h>        // Include standard I/O functions (for sprintf)
;#include <alcd.h>         // Include functions for alphanumeric LCD
;
;// Global variable declarations
;unsigned char i;          // Counter variable to be displayed on LCD
;char str[17];             // Character array to hold formatted string for LCD
;
;void init(void);          // Function prototype for hardware initialization
;
;void main(void)
; 0000 000D {
...
_main:
; .FSTART _main
; 0000 000E     init();               // Call initialization function
	RCALL _init
; 0000 000F 
; 0000 0010     lcd_init(16);         // Initialize LCD with 16 characters per line
	LDI  R26,LOW(16)
	CALL _lcd_init
; 0000 0011 
; 0000 0012     while (1)             // Infinite loop
_0x3:
; 0000 0013     {
; 0000 0014         // Format the counter value into a string with different styles:
; 0000 0015 
; 0000 0016         sprintf(str,"value=%03d",i);      // Zero-padded to 3 digits (e.g., 001)
	LDI  R30,LOW(_str)
	LDI  R31,HIGH(_str)
	ST   -Y,R31
	ST   -Y,R30
	...
	CALL _sprintf
	ADIW R28,8
; 0000 0017         // sprintf(str,"value=%d",i);      // Normal formatting
; 0000 0018         // sprintf(str,"value=%3d",i);     // Right-aligned with width 3
; 0000 0019         // sprintf(str,"value=%-3d",i);    // Left-aligned with width 3
; 0000 001A 
; 0000 001B         lcd_gotoxy(0,0);  // Set LCD cursor to column 0, row 0
	LDI  R30,LOW(0)
	ST   -Y,R30
	LDI  R26,LOW(0)
	CALL _lcd_gotoxy
; 0000 001C         lcd_puts(str);    // Display the formatted string on LCD
	LDI  R26,LOW(_str)
	LDI  R27,HIGH(_str)
	CALL _lcd_puts
; 0000 001D         delay_ms(500);     // Wait for 50 milliseconds
	LDI  R26,LOW(500)
	LDI  R27,HIGH(500)
	CALL _delay_ms
; 0000 001E         i++;              // Increasem  the counter
	INC  R5
; 0000 001F     }
	RJMP _0x3
; 0000 0020 }
...
; 0000 002B DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (0<<DDA0);
	LDI  R30,LOW(0)
	OUT  0x1A,R30
; 0000 002C // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=P
; 0000 002D PORTA=(0<<PORTA7) | (0<<PORTA6) | (0<<PORTA5) | (0<<PORTA4) | (0<<PORTA3) | (0<<PORTA2) | (0<<PORTA1) | (1<<PORTA0);
	LDI  R30,LOW(1)
	OUT  0x1B,R30
; 0000 002E 
...
; 0000 0091 // RS - PORTB Bit 1
; 0000 0092 // RD - PORTB Bit 2
; 0000 0093 // EN - PORTB Bit 3
; 0000 0094 // D4 - PORTB Bit 4
; 0000 0095 // D5 - PORTB Bit 5
; 0000 0096 // D6 - PORTB Bit 6
; 0000 0097 // D7 - PORTB Bit 7
