...
_0x3:
; 0000 0011       {
; 0000 0012       PORTB = digit[i];     // Send the pattern for digit[i] to PORTB ? display number on 7-segment
	MOV  R30,R5
	LDI  R31,0
...
; 0000 0013       delay_ms(500);
	...
	LDI  R27,HIGH(500)
	CALL _delay_ms
; 0000 0014       i++;                  // Go to next digit
	INC  R5
; 0000 0015       i= i==10 ? 0:i;       // If i reaches 10, reset it back to 0
	LDI  R30,LOW(10)
	CP   R30,R5
	BRNE _0x6
	LDI  R30,LOW(0)
...
; 0000 0021 
; 0000 0022 // Configure PORTA , PORTB as output
; 0000 0023 
; 0000 0024 DDRA=0xFF;
	LDI  R30,LOW(255)
	OUT  0x1A,R30
